...
public class VoxelShapeAlignedCuboidOffset extends VoxelShapeAlignedCuboid {
    ...
    private static double limitMovement(double maxDist, int segmentsA, double shapeOffsetA, double bMinA, double bMaxA, double bMinB, double bMaxB, double bMinC, double bMaxC, double sMinA, double sMaxA, double sMinB, double sMaxB, double sMinC, double sMaxC) {
        double maxMovement = VoxelShapeAlignedCuboidOffset.limitMovement(maxDist, segmentsA, shapeOffsetA, sMinA, sMaxA, bMinA, bMaxA);
