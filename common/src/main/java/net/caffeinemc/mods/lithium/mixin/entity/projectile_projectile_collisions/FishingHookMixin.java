...
public class FishingHookMixin {
    ...
    @Definition(id = "canHitEntity", method = "Lnet/minecraft/world/entity/projectile/FishingHook;canHitEntity(Lnet/minecraft/world/entity/Entity;)Z")
    @Expression("this::canHitEntity")
    @ModifyExpressionValue(
            method = "checkCollision", at = @At("MIXINEXTRAS:EXPRESSION")
    )
